...
export const Rocket: StoryObj<ModalProps> = {
    args: {
        isOpen: true,
        title: "Rocket",
        children: <RocketEditForm onSubmit={function (): void {
...
export const Crew: StoryObj<ModalProps> = {
    args: {
        isOpen: true,
        title: "Crew",
        children: <CrewEditForm onSubmit={function (): void {
            throw new Error("Function not implemented.");
        }} initialData={{
            id: 0,
            name: "",
...
export const Crewman: StoryObj<ModalProps> = {
    args: {
        isOpen: true,
        title: "Crewman",
        children: <CrewmanEditForm onSubmit={function (): void {
            throw new Error("Function not implemented.");
        }} initialData={{
            id: 0,
            name: "",
...
export const Launch: StoryObj<ModalProps> = {
    args: {
        isOpen: true,
        title: "Launch",
        children: <LaunchEditForm onSubmit={function (): void {
            throw new Error("Function not implemented.");
        }} initialData={{
            id: 0,
            launchCode: 0,
