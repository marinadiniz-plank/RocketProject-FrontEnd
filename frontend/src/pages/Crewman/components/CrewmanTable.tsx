...
const CrewmanTable: React.FC<CrewmanTableModal> = ({ data, updateCrewman, deleteCrewman }) => {
                            ...
                            <tr key={item.id}>
                                ...
                                <td className="edit_btn">
                                    <UpdateButton title={"Crewman"} >
                                        <CrewmanEditForm formLabels={Object.keys(item)} initialData={item} onSubmit={handleUpdateCrewman} />
                                    </UpdateButton>
