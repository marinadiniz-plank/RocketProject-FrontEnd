...
export const CrewEditForm: React.FC<FormProps> = ({
  ...
  const [crewman, setCrewman] = useState<string>(initialData.crewman.map((crew) => crew.id).join(', '));
  ...
  const handleInputChangeCrewman = (event: React.ChangeEvent<HTMLInputElement>) => {
